        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {services.map((service, i) => (
            ...
            >
              <Link
                href={service.href}
                className="group block rounded-2xl bg-white/[0.08] backdrop-blur-sm p-8 h-full min-h-[260px] transition-all duration-500 hover:bg-white/[0.12] hover:-translate-y-1"
              >
                {/* Icon */}
                <div className="w-12 h-12 rounded-full bg-[#d4af37]/10 flex items-center justify-center text-[#d4af37] mb-6 group-hover:bg-[#d4af37]/20 transition-all duration-400">
                  {service.icon}
                </div>
