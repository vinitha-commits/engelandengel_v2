...
const eventsData: { [key: string]: any } = {
  ...
  'lacba-litigation-section-meeting-2025': {
    ...
    fullDescription: `
      ...
      <p>Brandon Engel, CPA, CFE, ABV is a partner at Engel & Engel LLP with over 30+ years of experience in forensic accounting and expert witness testimony. He has testified in hundreds of cases involving fraud, economic damages, business valuation, and financial disputes.</p>
