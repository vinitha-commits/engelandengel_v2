          ...
          <div className="container-custom py-4">
            <div className="max-w-4xl mx-auto">
              <p className="text-sm text-yellow-900">
                <strong>DRAFT — FOR CLIENT REVIEW.</strong> This template is generic boilerplate and should be reviewed by an attorney to confirm it meets the firm&apos;s professional and regulatory obligations.
              </p>
            </div>
          </div>
        </section>
