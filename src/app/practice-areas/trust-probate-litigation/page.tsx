      ...
      <main className="bg-slate-50 min-h-screen text-slate-900 overflow-hidden">
                ...
                >
                  <div className="space-y-8">
                    <div className="space-y-6">
                      <p className="text-slate-600 leading-relaxed text-xl text-slate-700 font-medium" dangerouslySetInnerHTML={{ __html: "Trust, estate, and probate disputes often arise from poor recordkeeping, lack of transparency, or intentional misconduct. Questions surrounding the management of trust assets, valuation of estates, and accuracy of accounting can quickly escalate into litigation when beneficiaries suspect mismanagement or fraud.<br/><br/>At Engel & Engel, LLP, we work closely with attorneys to untangle complex financial records, trace assets, and provide the forensic accounting analysis necessary to resolve these disputes. Our team brings clarity and precision to cases where the truth is hidden within years of financial activity.<br/><br/>With decades of experience in forensic accounting, Engel & Engel provides the financial expertise needed to investigate trust and estate disputes, evaluate claims, calculate damages, and deliver findings that withstand scrutiny in court." }}></p>
                    </div>
                  </div>
                </motion.div>
        ...
        <section className="py-16 lg:py-24 bg-slate-50 relative overflow-hidden">
          <div className="container-custom max-w-5xl relative z-10">
            ...
            >
              <h2 className="text-2xl md:text-3xl font-bold text-[#0f3574] leading-tight mb-8 pb-3 border-b-2 border-[#0f3574] w-fit"> How Engel & Engel Helps Trust/Probate Attorneys </h2>
              ...
              <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                  <li key="Tracing and Recovery of Assets" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    ...
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Tracing and Recovery of Assets"}</span>
                  </li>
                  <li key="Verification of Trust and Estate Accountings" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 text-[#0f3574] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0f3574] group-hover:text-white transition-colors duration-300">
                      <div className="w-2 h-2 rounded-full bg-current" />
                    </div>
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Verification of Trust and Estate Accountings"}</span>
                  </li>
                  <li key="Investigation of Misappropriation of Assets" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 text-[#0f3574] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0f3574] group-hover:text-white transition-colors duration-300">
                      <div className="w-2 h-2 rounded-full bg-current" />
                    </div>
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Investigation of Misappropriation of Assets"}</span>
                  </li>
                  <li key="Allocation of Trust Assets" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 text-[#0f3574] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0f3574] group-hover:text-white transition-colors duration-300">
                      <div className="w-2 h-2 rounded-full bg-current" />
                    </div>
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Allocation of Trust Assets"}</span>
                  </li>
                  <li key="Estate Tax Return Analysis (Form 706)" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 text-[#0f3574] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0f3574] group-hover:text-white transition-colors duration-300">
                      <div className="w-2 h-2 rounded-full bg-current" />
                    </div>
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Estate Tax Return Analysis (Form 706)"}</span>
                  </li>
                  <li key="Real Estate Asset Diversion" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 text-[#0f3574] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0f3574] group-hover:text-white transition-colors duration-300">
                      <div className="w-2 h-2 rounded-full bg-current" />
                    </div>
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Real Estate Asset Diversion"}</span>
                  </li>
                  <li key="Business and Asset Valuation" className="flex items-start gap-3 p-4 bg-slate-50 rounded-2xl border border-blue-50 shadow-sm hover:shadow-md hover:border-blue-200 transition-all duration-300 group">
                    <div className="mt-1 w-6 h-6 rounded-full bg-blue-100 text-[#0f3574] flex items-center justify-center flex-shrink-0 group-hover:bg-[#0f3574] group-hover:text-white transition-colors duration-300">
                      <div className="w-2 h-2 rounded-full bg-current" />
                    </div>
                    <span className="text-[1.05rem] font-medium text-slate-700 leading-snug group-hover:text-[#0f3574] transition-colors">{"Business and Asset Valuation"}</span>
                  </li>
