...
const publications = [
    { title: 'Framework for the Calculation of Infringement Damages: Part I: "Trademark Infringement Damages Under the Lanham Act"', image: '/images/law7.png' },
    { title: 'Framework for the Calculation of Infringement Damages: Part II "Patent Infringement Damages"', image: '/images/law8.png' },
];
